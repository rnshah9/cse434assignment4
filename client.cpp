...
#define EVENT_NET_END_RETRIEVE_ACK 
#define EVENT_NET_FORWARD_MESSAGE
...
#define OPCODE_LOUGOUT_ACK 0x8F
...
int main() {
    ...
    returned = bind(sockfd, (struct sockaddr *)&my_addr, sizeof(my_addr));
    ...
    while (1) {
        ...
        if (FD_ISSET(fileno(stdin), &read_set)) {
            ...
            if (event == EVENT_USER_LOGIN) {
                ...
                // -ing anything.
            } else if (event == 1 /* some other event */) {
        ...
        if (FD_ISSET(sockfd, &read_set)) {
            ...
            returned = recv(sockfd, recv_buffer, sizeof(recv_buffer), 0);

            event = parse_the_event_from_the_received_message(0);
